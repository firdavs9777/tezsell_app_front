...
class _ServiceSkeletonBox extends StatefulWidget {
  final double width;
  final double height;
  final double borderRadius;
  final ColorScheme colorScheme;

  const _ServiceSkeletonBox({
    required this.width,
  ...
  @override
  State<_ServiceSkeletonBox> createState() => _ServiceSkeletonBoxState();
}

class _ServiceSkeletonBoxState extends State<_ServiceSkeletonBox>
